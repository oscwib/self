...
def NOTIFIED_ADD_CONTACT(op):
    try:
        sendMessage(op.param1, client.getContact(op.param1).displayName + " cie nge add wkwk")
...
def NOTIFIED_LEAVE_GROUP(op):
    try:
        sendMessage("dadah" + op.param1, client.getContact(op.param2).displayName + "dari tadi kek lu keluar grup\n└(○｀ε´○)┘")
    except Exception as e:
        print e
